...
// On window resize > 800px, move 'Read More/Read Less' button to 2nd paragraph
  $(window).resize(function(){
     ...
     if(width >= 800){
        ...
        $('.scroll-sub-section-paragraph:nth-child(2)').removeClass('complete-text');
     }
     else {
        $('.section-description-paragraph:nth-child(2)').addClass('complete-text');
        $('.scroll-sub-section-paragraph:nth-child(2)').addClass('complete-text');
     }
...
// On window resize > 1050px, move 'Read More/Read Less' button to 3rd paragraph and hide it
  $(window).resize(function(){
     ...
     if(width >= 1050){
         ...
         $('.scroll-sub-section-paragraph:nth-child(3)').removeClass('complete-text');
         $('.toggle-read-text').hide();
     }
     else{
         $('.section-description-paragraph:nth-child(3)').addClass('complete-text');
         $('.scroll-sub-section-paragraph:nth-child(3)').addClass('complete-text');
...
$(window).resize(function(){
      ...
      if(width >= 1050){
        // homepage
        $('.about.dropdown-slider-panel').show();
        $('.about.slider-wrapper').appendTo('.about.dropdown-slider-panel');
        // stand-up
        ...
        $('.dominated.slider-wrapper').appendTo('.dominated.dropdown-slider-panel');
          ...
          // homepage sliders
          $('.about.dropdown-slider-panel').hide();
          $('.movement.slider-wrapper').detach('.about.dropdown-slider-panel').appendTo('.movement.slider-wrapper-container');
          $('.strategy.slider-wrapper').detach('.about.dropdown-slider-panel').appendTo('.strategy.slider-wrapper-container');
          $('.technique.slider-wrapper').detach('.about.dropdown-slider-panel').appendTo('.technique.slider-wrapper-container');
          // stand-up
